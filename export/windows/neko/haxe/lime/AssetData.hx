...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/font/f12.TTF", Reflect.field (AssetType, "font".toUpperCase ()));
			path.set ("assets/images/moveUp1.png", "assets/images/moveUp1.png");
			type.set ("assets/images/moveUp1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("source/test.cdb", Reflect.field (AssetType, "text".toUpperCase ()));
